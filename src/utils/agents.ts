...
// the arxiv-cli to wire AGENTS.md / CLAUDE.md / GEMINI.md / etc.
...
export interface AgentConfig {
  ...
  appendOk: boolean;          // append arxiv section to existing rule file?
...
export const AGENTS: Record<AgentId, AgentConfig> = {
  ...
  cursor: {
    ...
    ruleFile: ".cursor/rules/arxiv.mdc", ruleFormat: "cursor", appendOk: false,
